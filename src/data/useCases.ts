...
export const useCases: UseCaseCard[] = [
  ...
  },
  {
    ...
    riskLevel: 'Средний',
    description:
      'Когнитивный кост-инженер: агенты сводят договор, фактически выполненные объёмы (КС-2/КС-3) и счёт — сверяют ставки, этапность освоения, лимиты и тайминг, собирают реестр к оплате. Вместо ручной проверки в SAP MM.',
